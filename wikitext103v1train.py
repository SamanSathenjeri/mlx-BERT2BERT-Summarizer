...
if __name__ == "__main__":
    ...
    if not os.path.exists("safetensors/wikitext103_mlm_preprocessed.safetensors"):
        dataset = load_dataset("wikitext", "wikitext-103-v1", split="train")
        block_size = 128
        ...
        print("Chunking...")
        chunks = list(tqdm(chunkify(input_ids, block_size), desc="Chunking"))
        ...
        input_ids_masked, labels = mask_tokens(chunks, tokenizer)
        ...
        mx.save_safetensors("safetensors/wikitext103_mlm_preprocessed.safetensors", train_data)

    else:
        print("Loading preprocessed dataset")
        train_data = mx.load("safetensors/wikitext103_mlm_preprocessed.safetensors")
